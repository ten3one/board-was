...
public class UpdateUserInfoResponseDto extends ResponseDto {
    ...
    private UpdateUserInfoResponseDto() {
        super(ResponseCode.SUCCESS, ResponseMessage.SUCCESS);
    }

    public static ResponseEntity<UpdateUserInfoResponseDto> success() {
        UpdateUserInfoResponseDto result = new UpdateUserInfoResponseDto();
